...
# C14 Position (Rear Wall)
c14_x = ssr_x 
c14_y = BOX_L/2 
c14_z = 45.0 

# Terminal Block - SHIFTED FORWARD 10mm for strain relief clearance
# Old Y: INTERNAL_L/2 - 30.0
# New Y: INTERNAL_L/2 - 40.0
term_x = pid_x 
...
with BuildPart() as base:
    ...
    with Locations((ssr_x, ssr_y, BASE_THICKNESS)):
        Box(SSR_W + 4, SSR_L + 4, SSR_PLATFORM_HEIGHT, align=(Align.CENTER, Align.CENTER, Align.MIN))
    ...
    # Labyrinth Strain Relief (Kept at rear to maximize wire run)
...
with BuildPart() as shell:
    ...
    with Locations((0, socket_y, BOX_H - ROOF_THICKNESS)):
        ...
        # Left Boss (With Bridge to Left Wall)
